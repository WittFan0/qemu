...
-vga vmware \
-netdev bridge,br=br1,id=net4 -device virtio-net-pci,netdev=net4,id=nic4,mac=02:00:00:00:00:04 \
-m 4G \
-drive if=pflash,format=raw,unit=1,file=/home/lance/Projects/qemu/ovmf_vars/host3_VARS.fd \
-drive file=/mnt/data0/iso/pop-os_22.04_amd64_intel_12.iso,index=1,media=cdrom,readonly=on \
-name host3
