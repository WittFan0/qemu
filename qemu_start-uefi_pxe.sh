...
-device virtio-vga \
-netdev tap,id=net1,helper=/usr/lib/qemu/qemu-bridge-helper -device virtio-net-pci,netdev=net1,id=nic1,mac=02:00:00:00:01:07,bootindex=1,romfile="" \
-m 8G \
-drive if=pflash,format=raw,unit=1,file=/home/lance/Projects/qemu/ovmf_vars/pxe_OVMF_VARS.fd \
