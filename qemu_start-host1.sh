...
-vga vmware \
-netdev bridge,br=br1,id=net2 -device virtio-net-pci,netdev=net2,id=nic2,mac=02:00:00:00:00:02 \
-m 4G \
-drive if=pflash,format=raw,unit=1,file=/home/lance/Projects/qemu/ovmf_vars/host1_VARS.fd \
-drive file=/mnt/data0/iso/linuxmint.iso,index=1,media=cdrom,readonly=on \
-name host1
